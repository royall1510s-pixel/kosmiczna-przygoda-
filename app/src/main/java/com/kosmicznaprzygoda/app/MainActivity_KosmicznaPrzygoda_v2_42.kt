...
class MainActivity : Activity() {
    ...
    inner class SpaceGameView : View(this) {
        ...
        private fun update(dt: Float) {
            ...
            /*
             * Właściwy lot:
             * - ciąg zwiększa prędkość,
             * - brak ciągu powoduje wyhamowanie,
             * - paliwo znika tylko podczas pracy silnika,
             * - temperatura rośnie przy dużej prędkości i ciągu,
             * - zbyt wysoka temperatura uszkadza rakietę.
             */
            if (
                thrust &&
                fuel > 0f
            ...
            if (
                ...
                /*
                 * Dotarcie do celu uruchamia podejście do lądowania.
                 * Właściwe lądowanie rozwiniemy w następnym etapie.
                 */
                phase = "landing"
        ...
        private fun game(
            ...
            text(
                c,
                "PIONOWO  ${verticalSpeed.toInt()} m/s",
                24f,
                170f,
                15f,
                true,
