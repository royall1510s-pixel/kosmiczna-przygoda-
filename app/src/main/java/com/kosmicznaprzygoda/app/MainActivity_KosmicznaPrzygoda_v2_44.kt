        ...
        private fun update(dt: Float) {
            ...
            if (phase != "flight") {
                ...
                if (phase == "landing") {
                    ...
                    // KONTROLOWANE LĄDOWANIE: gracz musi wyhamować
                    // rakietę przed kontaktem z powierzchnią.
                    val gravity = 95f

                    if (thrust && fuel > 0f && integrity > 0f) {
                        fuel = max(0f, fuel - 4.5f * dt)
                        landingVelocity = min(160f, landingVelocity + 230f * dt)
                        temperature = min(1200f, temperature + 95f * dt)
                    } else {
                        landingVelocity -= gravity * dt
                    ...
                    altitude += landingVelocity * dt / 100f
                    speed = abs(landingVelocity)
